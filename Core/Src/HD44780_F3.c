...
void HD44780_floatingNumberDisplay(float floatingNumberToBeDisplayed, uint8_t digitMaxLength);
...
/*********************************************************************************************
 Function name   : HD44780_floatingNumberDisplay
 Author 		 : Sagal Singh Kalra
 Date Modified   : 20/07/2021
 Compiler        : CubeMXIDE 1.6.1

 Description	 : Displays Floating Point Number

 Special Note(s) : NONE

 Parameters		 : floatingNumberToBeDisplayed
                   digitMaxLength
 Return value	 : NONE
 *********************************************************************************************/
void HD44780_floatingNumberDisplay(float floatingNumberToBeDisplayed, uint8_t digitMaxLength){
	char strNumber[digitMaxLength];
	sprintf(strNumber, "%.1f", floatingNumberToBeDisplayed);
	HD44780_PutStr(strNumber);
